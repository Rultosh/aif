export const questionsForMoreThanOne = {
    "selfRatingQuestions": [
        ...
        {
            "id": 16,
            "text": "Distributions to Paid-in-Capital in last Fund",
            "options": [
                ">=3x",
                ">=2x & <3x",
                ">=1x & <2x",
        ...
        {
            "id": 17,
            "text": "Number of LPs with exposure >5% of last Fund target corpus who continue to invest in the proposed fund",
            "options": [
                ">=5",
                ">=3 & <5",
                ">=1 & <3",
