...
import { saveFormData, submitResults, fetchTableData, createLead, fetchLead } from './profileSlice'
...
export const LeadTable = (props:any) => {

    const [open, setOpen] = useState(false);
    const handleOpen = () => setOpen(true);
    const handleClose = () => setOpen(false);
    //const rows = useAppSelector(state => state.profile.leadTableData) || [];
    const {rows} = props;
            ...
            <Card>
                <CardContent>
                    <Grid container spacing={2} >
                        <Grid item xs={12}>
                            <Box >
                                <Typography variant="subtitle2" sx={{ flex: 1, mb: 1 }}>Investmets responsible for (as Lead)</Typography>
