...
export const Reference = (props:any) => {
    ...
    const tableHeaders = ["Name of company", "Designation", "Organization", "Telephone No.", "Mobile No.", "Email", "Alternatie Email", "Action"]
            ...
            <Card>
                <CardContent>
                    <Grid container spacing={2} >
                        <Grid item xs={12}>
                            <Box >
                                <Typography variant="subtitle2" sx={{ flex: 1, mb: 1 }}>Two Independent references in r/o Team Member with regard to thier investment experience(other than investee companies) </Typography>
